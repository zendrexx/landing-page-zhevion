...
/**
 * Inertial scrolling, mounted once from the root layout.
 *
...
export function SmoothScroll() {
  useEffect(() => {
    ...
    const onClick = (e: MouseEvent) => {
      ...
      // No such target on this page yet (the nav's section anchors arrive in
      // later steps) — let the browser do whatever it normally would.
      if (!target) return;
